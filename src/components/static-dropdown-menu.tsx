...
const StaticDropdownMenu = () => {
  const [hoveredItem, setHoveredItem] = useState<
    null | "export" | "contact" | "disable" | "logout"
  >(null);
    ...
    <div className="flex flex-col w-48 bg-white rounded-2xl shadow-sm overflow-hidden">
      ...
      <div
        className={`flex flex-col p-3 ${
          hoveredItem === "export" ? "bg-gray-100" : "bg-white"
        }`}
      ...
      <div
        className={`flex flex-col p-3 ${
          hoveredItem === "contact" ? "bg-gray-100" : "bg-white"
        }`}
      ...
      <div
        className={`flex flex-col p-3 ${
          hoveredItem === "disable" ? "bg-gray-100" : "bg-white"
        }`}
      ...
      <div
        className={`flex flex-col p-3 ${
          hoveredItem === "logout" ? "bg-gray-100" : "bg-white"
        }`}
      ...
      >
        <div className="flex flex-row items-center gap-1">
          ...
          <span className="ml-1 text-sm font-medium text-red-400">Log out</span>
        </div>
      </div>
    </div>
  );
