...
> = ({
  ...
  const [selectedTransaction, setSelectedTransaction] =
    useState<Transactionss | null>(null);
  return (
            ...
            {transactionss.map((transact) => (
              <Dialog.Root key={transact.unique_id}>
                <Dialog.Trigger asChild>
                  <div
                    className="cursor-pointer flex flex-row justify-between items-center w-full border-b-2 p-[0.5rem] px-[1.3rem] border-[#F1F1F1]"
                    onClick={() => setSelectedTransaction(transact)}
                  >
                    <div className="flex flex-row gap-[1.5rem]">
                      <div
                        className="flex items-center justify-center w-[19%]  "
                        style={{
                          backgroundImage: "url('/usdbg.svg')",
                      ...
                      <div className="grid gap-[0.2rem] w-fit">
                        <h3 className="font-[500] text-[13px] text-[#9B9B9B] ">
                          {transact.date}
                        </h3>
                        <h4 className="text-[15px] font-[500] text-[#121212] w-full">
                          You recieved {""}
                          {transact.naira_received}
                        </h4>
                      </div>
                    </div>
                    <div className="flex flex-col gap-[0.2rem]">
                      <h4 className="text-[15px] font-[500] bg-gradient-to-r from-[#1F90FF] to-[#504CF6] text-transparent bg-clip-text">
                        +{""}
                        {""} {transact.crypto_value}
                      </h4>
                      <h3
                  ...
                  <Dialog.Content>
                    ...
                    >
                      ...
                      <div className="flex flex-row w-full gap-[2rem] items-center justify-center">
                        ...
                        <PrimaryButton
                          shortcut=" "
                          className="flex flex-row w-[50%] items-center justify-center cursor-pointer"
                        >
