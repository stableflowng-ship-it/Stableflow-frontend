...
import { PrimaryButton, TransactionHistoryContainer } from "@/components";
...
export default function Page() {
  ...
  return (
    <div className="w-screen h-screen overflow-y-scroll bg-[#f7f7f7] pt-2 pb-5">
      ...
      <div className="w-[600px] m-auto flex flex-col justify-between h-full grow">
        ...
        <div className="grow my-5 flex flex-col items-center justify-center">
          ...
          <p className="w-72 text-center mt-3 text-sm text-[#B3B3B3] font-medium">
            To get start you need to create a business and fill the necessary
            details.
          </p>
          <PrimaryButton
          ...
          <Dialog.Root open={open} onOpenChange={closee}>
            <div className="flex items-center justify-between w-full py-[0.7rem] px-[1rem] bg-transparent">
              ...
              >
                ...
                {inputValue ? (
                  <h3 className="text-[25px] text-[#121212] underline underline-offset-1 flex items-start font-[500]">
                    {inputValue}
                  </h3>
                ) : (
