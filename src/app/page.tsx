        ...
        <div className="ml-[1rem] lg:ml-0 grid lg:flex lg:flex-col gap-[16px] w-full  items-left justify-left">
          <div className="flex flex-row items-center gap-[5px] lg:px-[1.5rem]">
            ...
            <SecondaryButton className="cursor-pointer w-full">
              <h3 className="text-black font-[600] lg:mr-[0.5rem] text-[12px] text-nowrap lg:text-[16px]">
                Apply for payments kit
              </h3>
            </SecondaryButton>
          </div>
          <div className="flex text-left">
            <h3 className="text-[14px] font-[400] text-[#909090]">
              By logging in, you agree to our{" "}
              <span className="text-[#1E90FF]">Terms of service</span> &{" "}
              <span className="text-[#1E90FF]">Privacy Policy.</span>
            </h3>
          </div>
        </div>
      </div>
